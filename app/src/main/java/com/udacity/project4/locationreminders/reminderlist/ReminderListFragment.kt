...
import com.udacity.project4.locationreminders.AuthenticationActivity
    ...
    private fun navigateToAddReminder() {
        ...
        _viewModel.navigationCommand.postValue(
            NavigationCommand.To(
                com.udacity.project4.locationreminders.reminderlist.ReminderListFragmentDirections.toSaveReminder()
            )
        )
    }
